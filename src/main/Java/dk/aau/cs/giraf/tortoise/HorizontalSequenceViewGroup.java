 ...
 * 
 */
public class HorizontalSequenceViewGroup extends AdapterView<SequenceAdapter> {
	...
	public HorizontalSequenceViewGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		try {
			horizontalSpacing = a.getDimensionPixelSize(
					R.styleable.HorizontalSequenceViewGroup_horizontalSpacing,
					DEFAULT_HORIZONTAL_SPACING);
			itemWidth = a.getDimensionPixelSize(
					R.styleable.HorizontalSequenceViewGroup_horizontalItemWidth, DEFAULT_ITEM_WIDTH);
			itemHeight = a.getDimensionPixelSize(
					R.styleable.HorizontalSequenceViewGroup_horizontalItemHeight, DEFAULT_ITEM_HEIGHT);
		} finally {
			a.recycle();
		}
	...
	private class AutoScroller implements Runnable {
		...
		public AutoScroller() {
			this.scroller = getScroller(HorizontalSequenceViewGroup.this);;
		...
		public void reset() {
			timeBefore = -1;
			parent = HorizontalSequenceViewGroup.this;
		...
		public void run() {
			...
			HorizontalSequenceViewGroup.this.handleTouchMove(touchX + (currentScrollX - prevScrollX));
